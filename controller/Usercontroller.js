...
const register = async (req, res) => {
  try {
    ...
    return res.json({ token, user: { name: newUser.name, email: newUser.email, isAdmin: newUser.isAdmin }, success: true });
  } catch (error) {
    console.error(error);
...
export { login, register, forgotpassword, resetpassword, logout, getname };